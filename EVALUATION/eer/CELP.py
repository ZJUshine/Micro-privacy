...
class CELP(object):
    ...
    def anonymize_lsf(self,lsf):
        a1,a2,a3,a4,a5,b1,b2,b3,b4,b5 = self.anonypara
        lsf[0] = lsf[0] + b1
        lsf[1] = lsf[1] + b1
        lsf[0] = lsf[0] + a1*(lsf[1]-lsf[0])
        lsf[1] = lsf[1] - a1*(lsf[1]-lsf[0])

        lsf[2] = lsf[2] + b2
        lsf[3] = lsf[3] + b2
        lsf[2] = lsf[2] + a2*(lsf[3]-lsf[2])
        lsf[3] = lsf[3] - a2*(lsf[3]-lsf[2])
        
        lsf[4] = lsf[4] + b3
        lsf[5] = lsf[5] + b3
        lsf[4] = lsf[4] + a3*(lsf[5]-lsf[4])
        lsf[5] = lsf[5] - a3*(lsf[5]-lsf[4])

        lsf[6] = lsf[6] + b4
        lsf[7] = lsf[7] + b4
        lsf[6] = lsf[6] + a4*(lsf[7]-lsf[6])
        lsf[7] = lsf[7] - a4*(lsf[7]-lsf[6])

        lsf[8] = lsf[8] + b5
        lsf[9] = lsf[9] + b5
        lsf[8] = lsf[8] + a5*(lsf[9]-lsf[8])
        lsf[9] = lsf[9] - a5*(lsf[9]-lsf[8])
    ...
    def decoder_lsf(self, lsf, x, bbuf, ebuf, Zf, Zw, i):
