...
class CELP(object):
    ...
    def __init__(self, wave_path, save_path,
        ...
        self.SCB_num = SCB_num                               # Stochastic codebook index length                         # anonymization parameter
        # load codebook
        ...
        self.save_wav = save_wav                                                  # save the audio after codec                                                      # whether to anonymize the audio
    def run(self):
